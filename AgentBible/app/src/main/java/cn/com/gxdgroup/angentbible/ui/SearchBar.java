...
public class SearchBar extends RelativeLayout {
    ...
    private ClearListener mClearLinstener;

    public void setmClearLinstener(ClearListener linstener) {
        this.mClearLinstener = linstener;
    }
